...
/*   Updated: 2025/03/25 10:37:09 by kelmounj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	(1) && (map_x = (int)data->player.x_pos, map_y = (int)data->player.y_pos);
...
// 	if (data->ray.rayd_x < 0)
// 		(1) && (data->ray.step_x = -1, data->ray.side_x = (data->player.x_pos \
// 			- map_x) * data->ray.delta_x);
// 	else
// 		(1) && (data->ray.step_x = 1, data->ray.side_x = (map_x + 1 \
// 			- data->player.x_pos) * data->ray.delta_x);
// 	if (data->ray.rayd_y < 0)
// 		(1) && (data->ray.step_y = -1, data->ray.side_y \
// 			= (data->player.y_pos - map_y) * data->ray.delta_y);
// 	else
// 		(1) && (data->ray.step_y = 1, data->ray.side_y \
// 			= (map_y + 1 - data->player.y_pos) * data->ray.delta_y);
