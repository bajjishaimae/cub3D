...
brew install cmake
```
⚠️ If you're not using macOS or not using Homebrew, please refer to your system’s package manager or the <a>`[MLX42 repo](https://github.com/codam-coding-college/MLX42.git)`</a>for proper installation.
